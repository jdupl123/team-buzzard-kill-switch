...
def waypointSelect(currentPos, heading):
    ...
    """
    gpsCoords = np.array([ #fake
        [27.511888, 153.089826],
        [27.511728, 153.089782],
        [27.511798, 153.089667],
    ])

    #gpsCoords = np.array([ #real
    ...
    msg = Odometry()
    msg.pose.pose.position.x = gpsMinX
    msg.pose.pose.position.y = gpsMinY
